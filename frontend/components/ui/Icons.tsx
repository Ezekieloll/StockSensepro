...
export const SettingsIcon = ({ className = '', size = 20 }: IconProps) => (
    <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <path d="M12 1v6m0 6v6m5.2-13.2 4.2-4.2m-4.2 4.2-4.2-4.2m9.2 9.2h6m-6 0h-6m13.2 5.2 4.2 4.2m-4.2-4.2-4.2 4.2" />
    </svg>
);
...
export const BriefcaseIcon = ({ className = '', size = 20 }: IconProps) => (
    <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
