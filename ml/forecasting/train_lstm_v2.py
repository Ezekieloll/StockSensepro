"""
LSTM Training Script V2 (Upgraded)
...
def main():
    ...
    # Model
    model = LSTMBaseline(input_size=9, hidden_size=128).to(device)
    ...
    print("\n" + "="*80)
    print("🚀 STARTING LSTM V2 TRAINING")
    print("="*80)
    ...
    checkpoint = torch.load('models/best_lstm_v2.pt', weights_only=False)
    ...
    with open('models/lstm_v2_final_results.json', 'w') as f:
        json.dump({
    ...
    print("\n✅ Results saved to models/lstm_v2_final_results.json")
